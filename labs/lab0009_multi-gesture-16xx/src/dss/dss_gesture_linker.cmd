...
SECTIONS
{
    ...
    */ 
    ...
    .l3data_gDOA2D:  load=L3SRAM PAGE 1
    .l3data_gDOAIn: > L3SRAM PAGE 1
    .l3data_gDOAOut:> L3SRAM PAGE 1
    ...
    .fastCode: 
    {
        ...
        //mathlib.ae674(.text)
        dss_data_path.oe674 (.text:GestDemo_interFrameProcessingPart1)
        dss_data_path.oe674 (.text:GestDemo_interFrameProcessingPart2)
        /*dss_data_path.oe674 (.text:MmwDemo_processChirp)*/
        dss_data_path.oe674 (.text:GestDemo_interChirpProcessing)
    } load=L3SRAM PAGE 0, run=L1PSRAM PAGE 0, table(_GestDemo_fastCode_L1PSRAM_copy_table, compression=off)
    ...
    .overlay:
    {
        ...
        dss_main.oe674 (.text:GestDemo_dssInitTask)
        dss_main.oe674 (.text:main)
        dss_data_path.oe674 (.text:GestDemo_dataPathInitEdma)
    } > L3SRAM PAGE 0
