function [cfg] = defineCLICommands(sdkVersion, demoType)
    ...
    switch demoType
        ...
        case 'Incabin'
                        i=i+1;
            cfg(i).command = 'cuboidDef';
            cfg(i).parameters = struct('zone', 0, 'cube', 0, 'xMin', 0, 'xMax', 0, 'zMin', 0, 'zMax', 0, 'yMin', 0, 'yMax', 0);
            cfg(i).units = {};
            
            i=i+1;
            cfg(i).command = 'occStateMach';
            cfg(i).parameters = struct('numPointForEnterThreshold1', 0, 'avgSnrForEnterThreshold1', 0, ...
                'numPointForEnterThreshold2', 0, 'avgSnrForEnterThreshold2', 0, ...
                'numPointForStayThreshold', 0, 'avgSnrForStayThreshold', 0, ...
                'forgetThreshold', 0, 'numPointToForget', 0, 'overloadThreshold', 0);
            cfg(i).units = {};
        otherwise
    end
